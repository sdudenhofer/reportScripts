...
doctors = open('/home/itadmin/automation/ohsu.txt', 'r')
today = datetime.datetime.now()
c = datetime.timedelta(days=45)
d = today - c
yesterday = d.strftime("%Y-%m-%d")
day = today.strftime('%Y-%m-%d')

writer = pd.ExcelWriter('/home/itadmin/automation/files/OHSU-PD-' + str(day) + '.xlsx', engine='openpyxl')
...
msg = MIMEMultipart()
msg['Subject'] = " OHSU Phys Doc Report For: " + str(day)
recipients = ['setdud@mckweb.com', 'desshu@mckweb.com']

attachment = MIMEBase('application','octet-stream')
f = '/home/itadmin/automation/files/OHSU-PD-' + str(day) + '.xlsx'
