...
writer = pd.ExcelWriter('/home/itadmin/automation/files/pt-schedule-report-' + today + '.xlsx', engine='xlsxwriter')
...
#with xlsxwriter.Workbook('pt-schedule-report-' + today + '.xlsx') as workbook:
...
filename = '/home/itadmin/automation/files/pt-schedule-report-' + str(today) + '.xlsx'
msg = MIMEMultipart()
msg['Subject'] = 'Daily PT Surgery Schedule Report'
    # recipients needs to be edited for each file
recipients = ['setdud@mckweb.com', 'carwer@mckweb.com']
