...
writer = pd.ExcelWriter('urology-report-' + str(day) + '.xlsx', engine='openpyxl')
d_out = []
out_array = open('urology.csv', 'w+')
...
out_array.close()
df1 = pd.read_csv('urology.csv', sep=',')
