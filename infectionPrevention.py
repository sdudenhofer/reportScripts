...
FROM HOSPF062.RMBED T01 LEFT OUTER JOIN ORDERF062.NCTRN T02 ON T01.PAT# = T02.TRPAT# \
LEFT OUTER JOIN ORDERF062.NCPRM T03 ON T02.TRPRMID = T03.PRID \
LEFT OUTER JOIN HOSPF062.PATIENTS T04 ON T01.PAT# = T04.PATNO \
...
FROM HOSPF062.RMBED T01 INNER JOIN HOSPF062.PATIENTS T02 ON T01.PAT# = T02.PATNO \
INNER JOIN ORDERF062.NCTRN T03 ON T03.TRPAT# = T01.PAT# \
INNER JOIN ORDERF062.NCPRM T04 ON T03.TRPRMID = T04.PRID \
...
FROM HOSPF062.PATIENTS T01 INNER JOIN HOSPF062.CHPDRIP T02 ON T01.PATNO = T02.CIPAT# \
...
LEFT OUTER JOIN ORDERF062.NCTRN T03 ON T01.PAT# = T03.TRPAT# \
LEFT OUTER JOIN ORDERF062.NCPRM T04 ON T03.TRPRMID = T04.PRID \
WHERE T01.NURST IN ('CDU', 'CVIC', 'ICU', 'SCUJ', 'WHBC', 'PCU', 'CCU', 'MCU') \
